...
public class Craft2StarBotTurnin implements BotType {
	public static final int HTCSMODE_I2C_ADDRESS = 0x41;
	public static final int TOUCH_TIME = 2800;
	public static final int BUFF_TIME = 2400;
	...
	int goodcounter = 0;// start with 1 basic touch
	...
	public Craft2StarBotTurnin() throws IOException {
		byte buf = 1;
